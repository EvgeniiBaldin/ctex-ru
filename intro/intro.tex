...
Предполагается, что дистрибутив \LaTeX{} на компьютере уже установлен
...
возникает. Возможные шероховатости с русским языком в современных
...
создании нового tex-файла. После создания текста его необходимо
откомпилировать:
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{intro/intro-1}
