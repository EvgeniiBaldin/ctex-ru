...
% \end{itemize}
% \end{example}
Это далеко не все возможные шрифтовые стили, которые можно применять в
математической моде. Но лучше особо не перегружать формулы всякой
...
\]
\end{example}
Следует обратить внимание, что знак корня размещается в соответствии с
размерами подкоренного выражения. Если в выражении присутствует только
...
на другую строку знак, по которому формула разрывается, дублируется на
следующей строке. Например так:
\begin{verbatim}
a + b =
= c
\end{verbatim}
